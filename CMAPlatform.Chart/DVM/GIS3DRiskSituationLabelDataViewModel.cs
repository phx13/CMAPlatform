...
namespace CMAPlatform.Chart.DVM
{
    ...
    /// </summary>
    [Serializable]
    public class GIS3DRiskSituationLabelDataViewModel : ChartDataViewModel, IGIS3DDataViewModel, IGlobeStyle, ILonLat,
        IAltitude
    {
        /// <summary>
        ///     构造
        /// </summary>
        public GIS3DRiskSituationLabelDataViewModel()
        {
            m_CanSort = true;
        ...
        /// </summary>
        [Synchronous]
        [PropertyDescription("批号字段", Category = DescriptionEnum.数据设置, SubCategory = DescriptionEnum.数据设置,
        ...
        public DimensionColumnModel GroupKeyField
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(() => GroupKeyField);
            }
        }
        ...
        /// </summary>
        [Synchronous]
        [PropertyDescription("经度字段", Category = DescriptionEnum.数据设置, SubCategory = DescriptionEnum.数据设置,
            PropertyType = EditorType.Field, IsNecessary = true, RefreshChartData = true)]
        ...
        /// </summary>
        [Synchronous]
        [PropertyDescription("纬度字段", Category = DescriptionEnum.数据设置, SubCategory = DescriptionEnum.数据设置,
            PropertyType = EditorType.Field, IsNecessary = true, RefreshChartData = true)]
        ...
        /// </summary>
        [Synchronous]
        [PropertyDescription("高度字段", Category = DescriptionEnum.数据设置, SubCategory = DescriptionEnum.数据设置,
            PropertyType = EditorType.Field, IsNecessary = false, RefreshChartData = true)]
        ...
        /// </summary>
        [Synchronous]
        [PropertyDescription("类型名称字段", Category = DescriptionEnum.数据设置, SubCategory = DescriptionEnum.数据设置,
            PropertyType = EditorType.Field, IsNecessary = true, RefreshChartData = true)]
        public DimensionColumnModel TypeNameField
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(() => TypeNameField);
            }
        }
        ...
        /// </summary>
        [Synchronous]
        [PropertyDescription("告警级别字段", Category = DescriptionEnum.数据设置, SubCategory = DescriptionEnum.数据设置,
            PropertyType = EditorType.Field, IsNecessary = true, RefreshChartData = true)]
        public DimensionColumnModel LevelField
        {
            ...
            {
                m_LevelField = value;
                RaisePropertyChanged(() => LevelField);
            }
        }
        ...
        /// </summary>
        [Synchronous]
        [PropertyDescription("红色告警数量", Category = DescriptionEnum.数据设置, SubCategory = DescriptionEnum.数据设置,
            PropertyType = EditorType.Field, IsNecessary = true, RefreshChartData = true)]
        public DimensionColumnModel RedCountField
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(() => RedCountField);
            }
        }
        ...
        /// </summary>
        [Synchronous]
        [PropertyDescription("黄色告警数量", Category = DescriptionEnum.数据设置, SubCategory = DescriptionEnum.数据设置,
            PropertyType = EditorType.Field, IsNecessary = true, RefreshChartData = true)]
        public DimensionColumnModel YellowCountField
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(() => YellowCountField);
            }
        }
        ...
        /// </summary>
        [Synchronous]
        [PropertyDescription("橙色告警数量", Category = DescriptionEnum.数据设置, SubCategory = DescriptionEnum.数据设置,
            PropertyType = EditorType.Field, IsNecessary = true, RefreshChartData = true)]
        public DimensionColumnModel OrangeCountField
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(() => OrangeCountField);
            }
        }
        ...
        /// </summary>
        [Synchronous]
        [PropertyDescription("蓝色告警数量", Category = DescriptionEnum.数据设置, SubCategory = DescriptionEnum.数据设置,
            PropertyType = EditorType.Field, IsNecessary = true, RefreshChartData = true)]
        public DimensionColumnModel BlueCountField
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(() => BlueCountField);
            }
        }
