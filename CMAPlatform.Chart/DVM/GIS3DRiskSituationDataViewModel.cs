...
namespace CMAPlatform.Chart.DVM
{
    ...
    /// </summary>
    [Serializable]
    public class GIS3DRiskSituationDataViewModel : ChartDataViewModel, IGIS3DDataViewModel, IGlobeStyle
    {
        /// <summary>
        ///     构造
        /// </summary>
        public GIS3DRiskSituationDataViewModel()
        {
            m_CanSort = true;
        ...
        /// </summary>
        [Synchronous]
        [PropertyDescription("名称字段", Category = DescriptionEnum.数据设置, SubCategory = DescriptionEnum.数据设置,
        ...
        /// </summary>
        [Synchronous]
        [PropertyDescription("多边形字段", Category = DescriptionEnum.数据设置, SubCategory = DescriptionEnum.数据设置,
            PropertyType = EditorType.Field, IsNecessary = true, RefreshChartData = true)]
        ...
        /// </summary>
        [Synchronous]
        [PropertyDescription("边线颜色字段", Category = DescriptionEnum.数据设置, SubCategory = DescriptionEnum.数据设置,
            PropertyType = EditorType.Field, IsNecessary = true, RefreshChartData = true)]
        public DimensionColumnModel BorderBrushField
        {
            ...
            set
            {
                ...
                SmartSetColumn();
                RaisePropertyChanged(() => BorderBrushField);
            }
        }
        ...
        /// </summary>
        [Synchronous]
        [PropertyDescription("填充颜色", Category = DescriptionEnum.样式设置, SubCategory = DescriptionEnum.颜色样式,
        ...
        /// </summary>
        [Synchronous]
        [PropertyDescription(DescriptionEnum.边线宽度, Category = DescriptionEnum.样式设置, SubCategory = DescriptionEnum.颜色样式,
            MinValue = 0, MaxValue = 200, DefaultValue = 1)]
